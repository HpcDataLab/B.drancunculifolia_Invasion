...
f_clas <- "all"
args <- NULL
maxent_path <- "/Users/ulises/Desktop/baccharis10m"
wait <- FALSE
run <- FALSE
```
...
kuenm_mmop(G.var.dir = G_var_dir, M.var.dir = M_var_dir, is.swd = is_swd,
           sets.var = sets_var, out.mop = out_mop, percent = percent, parallel = paral, n.cores = 23)
```


<br>

Perform extra analyses related to model extrapolation
```{r}
help(kuenm_modstats)
```


```{r Extra analyses, message=TRUE, warning=TRUE, paged.print=FALSE}
sp_name <- "baccharis"
